...
for (const key of ['family-tv-club', 'garden-ledger', 'green-culture', 'lesson-reel', 'local-signal', 'memory-bank', 'newsreel-exchange', 'print-shop', 'screen-test', 'sound-lab', 'stage-door', 'travel-reel', 'tv-time-machine', 'variety-hour', 'western-screen']) {
