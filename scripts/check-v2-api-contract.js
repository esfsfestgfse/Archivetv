...
const checks = [
  ...
  [worker.includes('const MAX_CATALOG_ITEMS = 96') && worker.includes('payload.candidateItems') && worker.includes('candidateItems: selectedCatalog'), 'IA fallback preserves the Durable Object catalog union instead of only the latest public shelf'],
