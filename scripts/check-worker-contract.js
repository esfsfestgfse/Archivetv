...
if (!/IA_QUEUE_CACHE_VERSION\s*=\s*"v65"/.test(source) || !/IA_LAST_GOOD_CACHE_VERSION\s*=\s*"v65"/.test(source)) issues.push('queue cache must invalidate stale exact and last-good shelves together');
