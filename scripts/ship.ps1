...
try {
  ...
  foreach ($contract in @('check-channel-registry.js', 'check-source-suite-contract.js', 'check-cast-contract.js', 'test-ia-hybrid-lineup.js', 'test-telemetry-lane-policy.js', 'test-custom-channel-contract.js')) {
