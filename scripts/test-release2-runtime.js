...
for (const file of builds) {
  ...
  check(html.includes('2.2.1-' + (file.includes('mobile') ? 'mobile' : 'desktop') + '.222-ia-manufacturing-rotation'), `${file}: build stamp is RealSignal 2.2.1 — IA Manufacturing Rotation`);
