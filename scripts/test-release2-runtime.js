...
for (const file of builds) {
  ...
  check(html.includes('2.2.1-' + (file.includes('mobile') ? 'mobile' : 'desktop') + '.224-ia-manufacturing-strict-recovery'), `${file}: build stamp is RealSignal 2.2.1 — IA Manufacturing Strict Recovery`);
